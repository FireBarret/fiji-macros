...
macro "✨Open all .czi &.tiff files in a Folder" {
    runMacro("openall.ijm");
}macro "✨Open all .czi files in a Folder" {
    runMacro("cziopen.ijm");
macro "✨Open all .tiff files in a Folder" {
    runMacro("tiffopen.ijm");
}
macro "Open Folder & Set to Composite" {
    runMacro("opencomposite.ijm");
}
macro "✨Set to Composite and save .jpeg" {
    runMacro("compositejpg.ijm");
}
macro "Z Project & Grayscale File" {
    runMacro("zpgraysingle.ijm");
}
macro "✨Z Project & Grayscale Folder" {
    runMacro("zpgray.ijm");
}
macro "Z Project & Crop Folder" {
    runMacro("zpgray 1by1.ijm");
}
